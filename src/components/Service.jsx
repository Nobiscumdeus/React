...
<<<<<<< HEAD
        <div data-aos="fade-out" className="service bg-gray-800 rounded-lg p-8 text-center text-white hover:bg-fuchsia-800 hover:text-white transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
=======
