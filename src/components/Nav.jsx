...
const Nav=()=>{
            ...
            <ul classname="text-center text-xl p-20">
                <Link spy={true} smooth={true}  to="Home"> 
                 ...
                 <Link spy={true} smooth={true} to="About"> 
                    <li className="my-4 py-4 border-b border-slate-900 hover:bg-slate-800 hover:rounded"> About </li>
                 </Link>
                 <Link spy={true} smooth={true} to="Services"> 
                    <li className="my-4 py-4 border-b border-slate-900 hover:bg-slate-800 hover:rounded"> Services </li>
                 </Link>
                 <Link spy={true} smooth={true} to="Projects"> 
                    <li className="my-4 py-4 border-b border-slate-900 hover:bg-slate-800 hover:rounded"> Projects </li>
                 </Link>
                 <Link spy={true} smooth={true} to="Contact"> 
                    <li className="my-4 py-4 border-b border-slate-900 hover:bg-slate-800 hover:rounded"> Contact </li>
                 </Link>
            </ul>
        </div>
    </>
    return(
        ...
        <nav>
            <div className=" h-10vh flex justify-between z-50 text-white lg:py-5 px-20 py-4 flex-1 border-slate-800">
                <div className="flex items-center flex-1">
                    <span className="text-3xl text-fuchsia-800 font-bold"> Chasfat Projects</span>
                </div>
